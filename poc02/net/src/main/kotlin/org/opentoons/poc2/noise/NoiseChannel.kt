...
object NoiseChannel {
    ...
    private fun identityPayload(identity: NodeIdentity, noiseStatic: NoiseKeyPair): ByteArray =
    ...
    private fun verifyIdentityPayload(
        ...
        if (!NodeIdentity.verify(identityPub, signed, signature)) {
...
class SecureNoiseConnection(
    ...
    override fun receive(): ByteArray? = synchronized(recvState) {
        ...
        require(total in 0..org.opentoons.poc2.transport.Frames.MAX_FRAME) { "frame de $total B fora do limite" }
