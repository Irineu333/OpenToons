...
Módulo descartável da PoC **poc-03**. O entregável durável é [`docs/poc03-report.md`](../docs/poc03-report.md);
este código pode ser apagado depois. Ver [openspec/changes/poc-03](../openspec/changes/poc-03/proposal.md).
...
| `net/` | — (Gradle `:poc03:net`) | Kotlin/JVM | verificação Ed25519/hash do lado do app (D7) |
...
cd ..
./gradlew :poc03:android:assembleDebug      # variante rust
./gradlew :poc03:android-go:assembleDebug    # variante go
```
