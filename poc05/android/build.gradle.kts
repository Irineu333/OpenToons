...
// O código de src/main consome SÓ o :poc05:api; cada flavor contribui um único arquivo
...
dependencies {
    ...
    "tramaImplementation"(project(":poc05:trama"))
    "libp2pImplementation"(project(":poc05:libp2p")) {
