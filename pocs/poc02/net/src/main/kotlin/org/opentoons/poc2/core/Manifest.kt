...
/**
 * Manifesto assinado com proteção contra rollback (ADR-0003) — portado sem mudanças
 * funcionais do E3 do poc-01 (formato já validado; design D8 do poc-02).
 *
 * Valida o MECANISMO (Ed25519 + `seq` monotônico), não o schema definitivo.
 * Ed25519 via BouncyCastle (disponível também no Android, onde o provider
 * Ed25519 do JDK não existe).
 */
data class Manifest(
