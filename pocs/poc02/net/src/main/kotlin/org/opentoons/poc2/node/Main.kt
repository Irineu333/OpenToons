 ...
 *   ./gradlew :pocs:poc02:net:run --args="node --seed=pub --listen=4101 --public=SEU_IP:4101 --publish"
 * Nó bootstrap (pode ser outro processo/porta na mesma máquina):
 *   ./gradlew :pocs:poc02:net:run --args="node --seed=boot --listen=4100 --public=SEU_IP:4100 --peer=<id-do-pub>@SEU_IP:4101"
 * Cliente de teste JVM (de qualquer rede):
 *   ./gradlew :pocs:poc02:net:run --args="fetch --bootstrap=<id-do-boot>@SEU_IP:4100 --obra=opentoons/serie-teste --publisher=<id-do-pub>"
 * Servidor de eco TLS para o E1a no dispositivo (task 2.3/2.5):
 *   ./gradlew :pocs:poc02:net:run --args="tls-echo --seed=tls --listen=4102"
 *
