// Facade Go DESCARTÁVEL da PoC poc-03 (design D1, Tier B): superfície mínima sobre
// go-libp2p de referência, cross-compilada para Android via `gomobile bind` (.aar)
// e para desktop via `c-shared`. Ver openspec/changes/poc-03 e docs/poc03-report.md.
module github.com/opentoons/poc03/gofacade
