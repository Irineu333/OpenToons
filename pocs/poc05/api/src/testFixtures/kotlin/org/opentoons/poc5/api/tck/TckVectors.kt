...
import org.opentoons.poc5.api.ChapterPublisher
...
object TckVectors {
    ...
    val contentKeys: NodeKeys = NodeKeys.fromSeed("poc5-content")

    /** Chave ERRADA para o cenário de rejeição por assinatura de terceiro. */
    val wrongKeys: NodeKeys = NodeKeys.fromSeed("poc5-imposter")
...
class TamperingBlockstore(
    private val inner: org.opentoons.poc5.api.Blockstore,
) : org.opentoons.poc5.api.Blockstore by inner {
    override fun block(id: org.opentoons.poc5.api.ContentId): ByteArray? =
