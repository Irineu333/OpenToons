...
// estendido com o lado servidor em poc04/rust-facade) atrás do seam do :pocs:poc05:api (design D3).
// O binding Kotlin do UniFFI (facade.kt) é gerado pelo build do rust-facade e copiado para cá;
// a lib nativa é .so (Android, via jniLibs do app) ou .dylib (host macOS arm64, para :pocs:poc05:node).
