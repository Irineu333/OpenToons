...
// O código de src/main consome SÓ o :pocs:poc05:api; cada flavor contribui um único arquivo
// (BackendFactory) — a escolha vive inteiramente no grafo de dependências do build, 0 branch.

android {
    namespace = "org.opentoons.poc5.android"
    compileSdk = 36

    defaultConfig {
        applicationId = "org.opentoons.poc5.android"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "0.0.1-poc5"
    }
...
dependencies {
    ...
    "tramaImplementation"(project(":pocs:poc05:trama"))
    "libp2pImplementation"(project(":pocs:poc05:libp2p")) {
