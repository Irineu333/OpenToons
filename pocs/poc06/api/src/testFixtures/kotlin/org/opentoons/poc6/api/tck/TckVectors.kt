...
import org.opentoons.poc6.api.ChapterPublisher
...
object TckVectors {
    ...
    val contentKeys: NodeKeys = NodeKeys.fromSeed("poc6-content")

    /** Chave ERRADA para o cenário de rejeição por assinatura de terceiro. */
    val wrongKeys: NodeKeys = NodeKeys.fromSeed("poc6-imposter")
...
class TamperingBlockstore(
    private val inner: org.opentoons.poc6.api.Blockstore,
) : org.opentoons.poc6.api.Blockstore by inner {
    override fun block(id: org.opentoons.poc6.api.ContentId): ByteArray? =
