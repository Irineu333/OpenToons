...
// é escrito 100% contra a interface FullNode do :pocs:poc04:api — zero branch por backend. Os
...
dependencies {
    implementation(project(":pocs:poc04:api"))
    implementation(project(":pocs:poc04:trama"))
    implementation(project(":pocs:poc04:libp2p"))
    implementation(libs.kotlinx.coroutinesCore)
    // vetores/adulteração do TCK reusados pelos drivers de host (mesma obra nas 8 células)
    implementation(testFixtures(project(":pocs:poc04:api")))
