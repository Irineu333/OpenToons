...
// O código de src/main consome SÓ o :pocs:poc04:api; cada flavor contribui um único arquivo
...
dependencies {
    ...
    "tramaImplementation"(project(":pocs:poc04:trama"))
    "libp2pImplementation"(project(":pocs:poc04:libp2p")) {
