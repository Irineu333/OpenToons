...
// RPC de frames + membership/gossip) refatorada para trás do seam do :poc06:api (design D3).
...
dependencies {
    api(project(":poc06:api"))
    implementation(libs.bouncycastle.bcprov)
    implementation(libs.kotlinx.serialization.cbor)
    implementation(libs.kotlinx.coroutinesCore)

    testImplementation(testFixtures(project(":poc06:api")))
