package com.neoutils.opentoons.ui.icons
...
/**
 * Ícones do app como `ImageVector` construídos a partir dos path data do Material Design.
 * Evita depender do `material-icons-core` (descontinuado após 1.7.x e incompatível com o
 * baseline do Compose MP 1.11.1). Tintáveis via `Icon(tint = ...)` — favoritar e excluir
 * ficam consistentes.
 */
object AppIcons {

    val Favorite: ImageVector = materialIcon(
        "Favorite",
    ...
    val FavoriteBorder: ImageVector = materialIcon(
        "FavoriteBorder",
    ...
    val Edit: ImageVector = materialIcon(
        "Edit",
        "M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l" +
            "-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z",
    )
    ...
    private fun materialIcon(name: String, pathData: String): ImageVector =
        ImageVector.Builder(
            ...
            fill = SolidColor(Color.Black), // sobrescrito pelo tint do Icon
        ).build()
}
